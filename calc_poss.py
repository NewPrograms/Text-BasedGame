...
class Calculate:
    ...
    def calc_fail(self, stamina, health):
        return abs(1 - self.calc_success(stamina, health))
    ...
    def calc_poss_damage(self, n, damage):
        ...
        if n == 1:
            ...
            self.res = (damage - (damage - 1)) + self.calc_poss_damage(n-1, damage)
            self.possible_damage.append(self.res)
            return self.res  

    def get_possibilities(self,n, damage):
        ...
        self.calc_poss_damage(n, damage)
    ...
    def calculate_player_stamina_consumed(self, stamina):
        return (100/stamina*0.4)+3
    ...
    def undeadmon_att_succ(self, mon_health, mon_speed, mon_stamina, length_of_list):
        ...
        if len(self.total) >= 6:
            ...
            self.division(length_of_list, self.ans)
            self.get_final_val()
